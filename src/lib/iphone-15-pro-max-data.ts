...
export const IPHONE_REVIEWS: ProductReviewDetail[] = [
  ...
  {
    id: "iphone-r6",
    name: "Javed Ahmed Gujjar",
    city: "Amargarh, Malerkotla",
    rating: 5,
  ...
  },
  {
    ...
    city: "Thoraipakkam, chennai, nadu",
    rating: 5,
  ...
  },
  {
    ...
    city: "Vaishali Nagar, Jaipur, Rajasthan",
    rating: 5,
  ...
  },
  {
    id: "iphone-r19",
    name: "Alok Mishra",
    city: "Arera Colony, Bhopal, Madhya Pradesh",
    rating: 5,
  ...
  },
  {
    id: "iphone-r20",
    name: "Irfan Ali",
    city: "Station Road, ajmer, Rajasthan",
    rating: 5,
  ...
  {
    id: "iphone-r21",
    name: "Vikas Kumar Sinha",
    city: "Kankarbagh, Patna, Bihar",
    rating: 4,
  ...
  },
  {
    id: "iphone-r22",
    name: "Joyce Lal",
    city: "Landour, Mussoorie, Uttarakhand",
    rating: 5,
  ...
  },
  {
    ...
    city: "Sopore Town, Baramulla, Jammu & Kashmir",
    rating: 5,
  ...
  },
  {
    id: "iphone-r24",
    name: "Rajesh Tiwari",
    city: "Bistupur, Jamshedpur, Jharkhand",
    rating: 5,
  ...
  },
  {
    ...
    city: "Sector 22, Chandigarh, Chandigarh",
    rating: 5,
  ...
  // ── 1★ Review: Product delay but satisfied ──
  {
    id: "iphone-r28",
    name: "Sharon k Paul",
    city: "Connaught Place Area, Central Delhi",
    rating: 1,
    title: "Delay was frustrating but the phone itself is great",
    text: "Honestly, the whole delivery experience was a nightmare. The phone was supposed to arrive in 3 days but it took more than 10. I had to follow up multiple times and the tracking wasn't updating properly. Almost cancelled the order twice. That said, once the phone finally arrived, it was everything I hoped for — stunning display, incredible camera, and blazing fast performance. The 512GB storage is more than enough for all my apps and media. Just wish the seller would work on their logistics. Product wise I'm happy, but the wait was unbearable.",
    date: "2026-06-10",
    isVerified: true,
    helpfulCount: 8,
  },
  {
    ...
    city: "Harippad, Alappuzha",
    rating: 1,
    title: "Worth the wait? Almost not — but yes",
    text: "I ordered this expecting standard 2-3 day delivery. It took over a week and I was really annoyed. The courier company they use is unreliable and the tracking number didn't work for the first 4 days. I was this close to requesting a refund. But after using the phone for a few days, I have to admit — it's absolutely fantastic. The A17 Pro chip is lightning fast, the battery lasts me almost two days, and the camera quality is unreal. I just wish they'd been upfront about the delivery timeline. If you can be patient with shipping, the product is top-notch.",
    date: "2026-06-08",
    isVerified: true,
    helpfulCount: 5,
  },
  // ── 2★ Review: Packing issue ──
  {
    id: "iphone-r30",
    name: "Riya Chacko",
    city: "Irinjalakuda, Thrissur",
    rating: 2,
    title: "Packing was disappointing for such an expensive phone",
    text: "For a phone worth ₹47,000, I expected much better packaging. The box was placed inside a larger cardboard box with just a few strips of bubble wrap. There was empty space inside and the box was rattling around during transit. The corner of the iPhone box got crushed and the seal was partially broken. Thankfully the phone itself wasn't damaged, but this is not how you ship a premium product. The phone is excellent — fast, beautiful screen, great camera — but the packing experience left a bad taste. Please improve your packaging standards.",
    date: "2026-06-05",
    isVerified: true,
    helpfulCount: 12,
  },
  // ── 2★ Review: Delivery boy approach ──
  {
    id: "iphone-r31",
    name: "Faisal Rahman",
    city: "Kondotty, Malappuram",
    rating: 2,
    title: "Delivery boy's behaviour was unacceptable",
    text: "The phone itself is amazing — the performance, camera, and display are top class. No complaints about the product at all. But the delivery experience was quite unpleasant. The delivery person called and demanded that I come down to the gate instead of coming to my door. When I asked him to come up, he was rude and kept saying he was in a hurry. He didn't even wait for me to open and check the package. Just handed it over and rushed off. For a high-value item like this, the delivery service should be much more professional. Deducting stars purely for the delivery experience.",
    date: "2026-06-02",
    isVerified: true,
    helpfulCount: 10,
  },
