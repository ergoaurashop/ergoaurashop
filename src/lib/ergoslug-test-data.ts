// =====================================================================
// ErgoSlug Test — Payment Check Product Data
// Duplicate of the Messi Argentina 2026 Jersey page with price set to ₹1.
// This page is for internal payment testing only — NOT for public/indexing.
// =====================================================================
...
// -------------------------------------------------------------------
export const ERGO_TEST_PRODUCT_IMAGES: string[] = [
  "Home/71DbIUtPvCL._AC_SX569_.jpg",
  "Home/71h9Len6zzL._AC_SX569_.jpg",
  "Home/71iX74mi2kL._AC_SX569_.jpg",
...
// -------------------------------------------------------------------
export const ERGO_TEST_SIZES = ["S", "M", "L", "XL", "XXL"];

// -------------------------------------------------------------------
// Bundle offer configuration
// -------------------------------------------------------------------
export const ERGO_TEST_BUNDLE_OFFER = {
...
// -------------------------------------------------------------------
// Product data entry — price set to ₹1 for payment testing
// -------------------------------------------------------------------
export const ERGO_TEST_PRODUCT: Product = {
  id: "prod-ergoslug-test-test",
  name: "Messi Argentina 2026 Men's Local Jersey",
  slug: "ergoslug-test-test",
  description:
...
// Customer Reviews
// -------------------------------------------------------------------
export const ERGO_TEST_REVIEWS: ProductReviewDetail[] = [
  {
    id: "wc2026-r1",
    name: "Rohit S.",
...
// Review summary
// -------------------------------------------------------------------
export const ERGO_TEST_REVIEW_SUMMARY = {
  totalReviews: 128,
  averageRating: 4.8,
  ratingDistribution: {
    5: 98,
