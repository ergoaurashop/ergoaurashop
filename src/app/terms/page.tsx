...
const SECTIONS = [
  ...
  },
  {
    ...
    content: `We aim to process and dispatch orders within 1-3 business days. Estimated delivery timelines are provided as guidelines and are not guaranteed. Delivery times may vary based on location, courier partner availability, and unforeseen circumstances. As we ship internationally, orders may occasionally experience delays due to factors such as customs processing, carrier schedules, or regional logistics that are beyond our control. In such cases, your delivery time and estimated arrival (ETA) may be extended. Please be assured that we hand over every order promptly and will keep you informed of its progress throughout its journey. Risk of loss and title for products pass to you upon dispatch. You are responsible for providing accurate delivery address information. Failed delivery attempts due to incorrect addresses or non-availability may incur additional charges.`,
  },
  {
    id: "cancellation",
    title: "7. Cancellation & Refund Policy",
    content: `You may cancel an order within 24 hours of placement, provided the order has not yet entered "Shipped" status. Once an order is shipped, cancellations are not permitted. Approved refunds are processed within 7-14 business days. However, depending on banking protocols, intermediary verification procedures, and compliance requirements, the total refund cycle may extend up to 180 business days from the date of cancellation approval. A processing or restocking fee of up to 5% may be deducted from the refund amount. Where a return or refund request involves a product that was shipped internationally, our processing time may vary if we are awaiting confirmation from our shipping agents on the status of the returned item. Your refund will be processed promptly once this confirmation is received, and we will keep you updated on its status at every step. Refunds are issued only to the original payment method. Store credit may be issued at our sole discretion. We shall not be held liable for delivery failures due to force majeure events, including but not limited to natural disasters, strikes, governmental actions, courier partner issues, or circumstances beyond our reasonable control.`,
  },
  {
    id: "tracking",
