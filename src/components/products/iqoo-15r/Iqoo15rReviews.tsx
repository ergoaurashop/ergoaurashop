...
function StarRow({ rating }: { rating: number }) {
  return (
    <div className="iqoo15r-review-stars">
      {[1, 2, 3, 4, 5].map((star) => (
        <span key={star} className="iqoo15r-review-star">
...
function ReviewCard({ review }: { review: ProductReviewDetail }) {
  ...
  const reviewImages = IQOO_15R_REVIEW_IMAGES[review.id] || [];
  ...
  return (
    ...
    >
      <div className="iqoo15r-review-header">
        {/* Blue avatar with initials */}
        <div className="iqoo15r-review-avatar">{getInitials(review.name)}</div>
        <div>
          <div className="iqoo15r-review-name">{review.name}</div>
          <div className="iqoo15r-review-city">{review.city}</div>
        </div>
      </div>
      ...
      <h4 className="iqoo15r-review-title">{review.title}</h4>
      <p className="iqoo15r-review-text">{review.text}</p>

      {/* ── Review photo carousel ── */}
      {reviewImages.length > 0 && (
        <div className="iqoo15r-review-images">
          {reviewImages.map((filename, i) => (
            <div
              key={filename}
              className="iqoo15r-review-image-wrapper"
      ...
      {reviewImages.length > 1 && (
        <div className="iqoo15r-review-carousel-nav">
          <button
            className="iqoo15r-review-carousel-btn"
            onClick={() =>
              setCurrentImg((prev) =>
          ...
          <div className="iqoo15r-review-carousel-dots">
            {reviewImages.map((_, i) => (
              <button
                key={i}
                className={`iqoo15r-review-carousel-dot${i === currentImg ? " active" : ""}`}
                onClick={() => {
                  setCurrentImg(i);
                  openLightbox(i);
                }}
      ...
      <div className="iqoo15r-review-meta">
        {review.isVerified && (
          <span className="iqoo15r-review-verified">
            <VerifiedCheckmark />
            Verified Purchase
          </span>
        )}
        <button
          ...
          className={`iqoo15r-review-helpful ${thumbsUp ? "thumbs-up-active" : ""}`}
      ...
      {lightboxOpen && (
        <div
          className="iqoo15r-review-lightbox"
        ...
        >
          <button
            className="iqoo15r-review-lightbox-close"
            onClick={closeLightbox}
...
function RatingBarRow({
  ...
  return (
    <div
      className={`iqoo15r-rating-row ${isActive ? "active" : ""}`}
      onClick={onClick}
      role="button"
      tabIndex={0}
      onKeyDown={(e) => {
    ...
    >
      <span className="iqoo15r-rating-label">{star}★</span>
      <div className="iqoo15r-rating-bar-track">
        <div className="iqoo15r-rating-bar-fill" style={{ width: `${pct}%` }} />
      </div>
      <span className="iqoo15r-rating-count">{count}</span>
    </div>
  );
}

/* ── Main Reviews Component ── */
export default function Iqoo15rReviews() {
  ...
  const summary = IQOO_15R_REVIEW_SUMMARY;

  // Filter
  let filtered = filterStar
    ? IQOO_15R_REVIEWS.filter((r) => r.rating === filterStar)
    : [...IQOO_15R_REVIEWS];
  ...
  return (
    <section className="iqoo15r-reviews-section" id="iqoo15r-reviews">
      <div className="iqoo15r-reviews-container">
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-8">
            <h2 className="iqoo15r-section-title">Customer Reviews</h2>
          ...
          <div className="iqoo15r-rating-bars">
            <div className="iqoo15r-rating-summary">
              <div className="iqoo15r-average-rating">
                {summary.averageRating.toFixed(1)}
              </div>
              <div>
                <div className="iqoo15r-average-stars">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <span key={star} className="iqoo15r-review-star">
                      <StarIcon
                ...
                <div className="iqoo15r-total-reviews">
            ...
            <div className="iqoo15r-rating-bars-title">
          ...
          {/* Toolbar: count + sort */}
          <div className="iqoo15r-reviews-toolbar">
            <span className="iqoo15r-reviews-count">
              {filtered.length} review{filtered.length !== 1 ? "s" : ""}
              {filterStar ? ` (${filterStar}★)` : ""}
            </span>
            <div className="iqoo15r-reviews-sort">
              <label htmlFor="iqoo15r-sort">Sort by:</label>
              <select
                id="iqoo15r-sort"
                value={sortBy}
                onChange={(e) =>
          ...
          {filtered.length > 8 && (
            <button
              ...
              className="iqoo15r-reviews-load-more"
            >
