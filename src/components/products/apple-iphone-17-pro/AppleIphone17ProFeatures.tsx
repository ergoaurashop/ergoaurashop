...
import {
  APPLE_IPHONE_17_PRO_KEY_FEATURES,
...
export default function AppleIphone17ProFeatures() {
  const features = APPLE_IPHONE_17_PRO_KEY_FEATURES;
  ...
  const breakImage = `/images/products/${APPLE_IPHONE_17_PRO_FOLDER}/${APPLE_IPHONE_17_PRO_PRODUCT_IMAGES[2]}`;

  return (
    <section
      className="appleiphone17pro-section appleiphone17pro-section-dark"
      id="appleiphone17pro-features"
    >
      <div className="appleiphone17pro-section-container">
        ...
        >
          <span className="appleiphone17pro-section-label">Key Features</span>
          <h2 className="appleiphone17pro-section-title">What Makes It Extraordinary</h2>
          <p className="appleiphone17pro-section-subtitle mx-auto">
            A19 Pro performance, a triple 48MP camera array, and a stunning
            120Hz ProMotion display — the iPhone 17 Pro redefines premium.
          </p>
        </motion.div>
            ...
            <div key={feature.title}>
              ...
              >
                ...
                >
                  ...
                  <h3 className="appleiphone17pro-alternating-title">{feature.title}</h3>
                  <p className="appleiphone17pro-alternating-desc">
                    {feature.description}
                  </p>
                </motion.div>
                <motion.div
              ...
              {i === 1 && breakImage && (
                <div className="appleiphone17pro-fullwidth-break my-12">
                  <Image
                    src={breakImage}
                    alt="Apple iPhone 17 Pro showcase"
                    fill
                    sizes="100vw"
                    style={{ objectFit: "cover" }}
                  />
