...
export default function LavaAgni4CameraSection() {
  const { highlights, features } = LAVA_AGNI_4_CAMERA_CONTENT;
  ...
  const breakImage = `/images/products/${LAVA_AGNI_4_FOLDER}/${LAVA_AGNI_4_PRODUCT_IMAGES[6]}`;

  return (
    <section className="lavaagni4-section" id="lavaagni4-camera">
      <div className="lavaagni4-section-container">
        ...
        >
          <span className="lavaagni4-section-label">Camera System</span>
          <h2 className="lavaagni4-section-title">
            {LAVA_AGNI_4_CAMERA_CONTENT.title}
          </h2>
          <p className="lavaagni4-section-subtitle mx-auto">
            {LAVA_AGNI_4_CAMERA_CONTENT.subtitle}
          </p>
        </motion.div>
            ...
            <div key={lens.label}>
              ...
              >
                ...
                >
                  ...
                  <h3 className="lavaagni4-alternating-title">{lens.label}</h3>
                  <p className="lavaagni4-alternating-desc">{lens.detail}</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: i % 2 === 0 ? 40 : -40 }}
                  whileInView={{ opacity: 1, x: 0 }}
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <div className="lavaagni4-glass-card max-w-3xl mx-auto">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {features.map((feature, i) => (
                <li
                  key={i}
                  className="flex items-start gap-2 text-sm text-[var(--lavaagni4-text-tertiary)]"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    className="w-4 h-4 mt-0.5 shrink-0 text-[var(--lavaagni4-accent-text)]"
                  >
