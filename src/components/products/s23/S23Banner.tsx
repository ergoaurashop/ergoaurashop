...
const IMAGE_BASE_PATH = `/images/products/${encodePath(S23_FOLDER)}/`;

export default function S23Banner() {
  ...
  const handleBannerClick = () => {
    router.push("/products/samsung-galaxy-s23-ultra");
  };
    ...
    >
      ...
      <div className="relative z-10 flex items-center h-full">
        ...
        >
          ...
          >
            512GB · Graphite / 200MP cam · S Pen · 8K video
          </p>
        ...
        >
          ...
          >
            <defs>
              <linearGradient id="s23ScreenShimmer" x1="0" y1="0" x2="1" y2="1">
        ...
        >
          ...
          >
            <div className="flex items-baseline gap-[6px]">
              ...
              >
                {formatPrice(S23_PRODUCT.original_price ?? 0)}
              </span>
              <span
                style={{
                  fontSize: "22px",
          ...
          <div className="flex items-center gap-[6px]">
            ...
            >
              {S23_REVIEW_SUMMARY.averageRating} ·{" "}
              {S23_REVIEW_SUMMARY.totalReviews}+ reviews
            </span>
          </div>
        </div>
      </div>
