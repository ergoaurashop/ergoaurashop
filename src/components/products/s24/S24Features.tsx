...
export default function S24Features() {
  const features = S24_KEY_FEATURES;
  ...
  // Full-width break image (fallback to valid S24 index — 527b8ee7...jpg)
  const breakImage =
    S24_PRODUCT_IMAGES.find((img) => img.includes("527b8ee7")) ||
    S24_PRODUCT_IMAGES[8];

  return (
    <section className="s24-section" id="s24-features">
      <div className="s24-section-container">
        ...
        >
          <span className="s24-section-label">Key Features</span>
          <h2 className="s24-section-title">
            Why the S24 Ultra Still Dominates
          </h2>
            ...
            <div key={feature.title}>
              ...
              >
                ...
                <div>
                  ...
                  <h3 className="s24-alternating-title">{feature.title}</h3>
                  <p className="s24-alternating-desc">{feature.description}</p>
                </div>
              </motion.div>
              ...
              {i === 1 && breakImage && (
                ...
                >
                  <Image
                    ...
                    alt="Samsung Galaxy S24 Ultra detail"
                    fill
                    unoptimized
                    sizes="100vw"
                    className="object-cover"
