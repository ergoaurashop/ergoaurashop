...
import {
  OPPO_K13_TURBO_5G_CAMERA_CONTENT,
...
export default function OppoK13Turbo5gCameraSection() {
  const { highlights, features } = OPPO_K13_TURBO_5G_CAMERA_CONTENT;
  ...
  const breakImage = `/images/products/${OPPO_K13_TURBO_5G_FOLDER}/${OPPO_K13_TURBO_5G_PRODUCT_IMAGES[6]}`;

  return (
    <section className="oppok13turbo5g-section" id="oppok13turbo5g-camera">
      <div className="oppok13turbo5g-section-container">
        ...
        >
          <span className="oppok13turbo5g-section-label">Camera System</span>
          <h2 className="oppok13turbo5g-section-title">
            {OPPO_K13_TURBO_5G_CAMERA_CONTENT.title}
          </h2>
          <p className="oppok13turbo5g-section-subtitle mx-auto">
            {OPPO_K13_TURBO_5G_CAMERA_CONTENT.subtitle}
          </p>
        </motion.div>
            ...
            <div key={lens.label}>
              ...
              {i === 1 && breakImage && (
                <div className="oppok13turbo5g-fullwidth-break my-12">
                  <Image
                    src={breakImage}
                    alt="OPPO K13 Turbo 5G camera system"
                    fill
                    sizes="100vw"
                    style={{ objectFit: "cover" }}
                  />
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <div className="oppok13turbo5g-glass-card max-w-3xl mx-auto">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {features.map((feature, i) => (
                <li
                  key={i}
                  className="flex items-start gap-2 text-sm text-[var(--oppok13turbo5g-text-tertiary)]"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    className="w-4 h-4 mt-0.5 shrink-0 text-[var(--oppok13turbo5g-accent-text)]"
                  >
